...
import { MathQuillExpressionFieldCreator } from 'extensions/creations/MathQuillExpressionField/MathQuillExpressionFieldCreator'
	...
	defaults(): object {
		return {
			creationConstructors: {
				...
				'expression': MathQuillExpressionFieldCreator,
				'sum': SumBoxCreator,
