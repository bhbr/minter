...
export class IntersectionPoint extends Point {
    ...
    arrowArrowIntersection(arrow1, arrow2) {
        ...
        let lambda = (CD.y * AC.x - CD.x * AC.y) / det;
        let mu = (AB.y * AC.x - AB.x * AC.y) / det;
        let Q = A.add(AB.multiply(lambda));
        let intersectionFlag1 = (arrow1.constructor.name == 'Segment' && lambda > 0 && lambda < 1) || (arrow1.constructor.name == 'Ray' && lambda > 0) || (arrow1.constructor.name == 'Line');
        let intersectionFlag2 = (arrow2.constructor.name == 'Segment' && mu > 0 && mu < 1) || (arrow2.constructor.name == 'Ray' && mu > 0) || (arrow2.constructor.name == 'Line');
