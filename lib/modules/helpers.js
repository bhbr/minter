...
export function extremeComponent(vertices, index, direction) {
...
export function xMin(vertices) {
    return extremeComponent(vertices, 0, -1);
}
export function xMax(vertices) {
    return extremeComponent(vertices, 0, 1);
}
export function yMin(vertices) {
    return extremeComponent(vertices, 1, -1);
}
export function yMax(vertices) {
    return extremeComponent(vertices, 1, 1);
}
export function midX(vertices) {
    return (xMin(vertices) + xMax(vertices)) / 2;
}
export function midY(vertices) {
    return (yMin(vertices) + yMax(vertices)) / 2;
}
export function ulCorner(vertices) {
    return new Vertex(xMin(vertices), yMin(vertices));
}
export function urCorner(vertices) {
    return new Vertex(xMax(vertices), yMin(vertices));
}
export function llCorner(vertices) {
    return new Vertex(xMin(vertices), yMax(vertices));
}
export function lrCorner(vertices) {
