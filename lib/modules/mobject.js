...
import { remove, stringFromPoint, rgb, pointerEventVertex, addPointerDown, removePointerDown, addPointerMove, removePointerMove, addPointerUp, removePointerUp } from './helpers';
...
export class Mobject {
    ...
    get fillColor() { return this.view['fill-color']; }
    ...
    get fillOpacity() { return this.view['fill-opacity']; }
    ...
    get strokeWidth() { return this.view['stroke-width']; }
