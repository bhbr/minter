...
export class Mobject {
    ...
    positionView() {
        if (!this.parent || !this.view || !this.anchor) {
            return;
        }
        console.log(this);
    ...
    properWidth() { return this.localXMax() - this.localXMin(); }
    properHeight() { return this.localYMax() - this.localYMin(); }
    ...
    globalAnchor() { return this.parent.globalTransform().appliedTo(this.anchor); }
}
